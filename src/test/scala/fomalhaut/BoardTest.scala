...
//   )
 ...
 "A position after 1.e4 " should " give such list of Moves for black" in {
    val board: Board = new FENParser().parseFENDescriptiontToBoard("rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR b KQkq - 0 1")
  ...
  "A board after 1.e4 e5 " should " give such list ov moves" in {
    val board: Board = new FENParser().parseFENDescriptiontToBoard("rnbqkbnr/pppp1ppp/8/4p3/4P3/8/PPPP1PPP/RNBQKBNR w KQkq - 0 1")
  ...
  "A board without pawns" should " give such list of moves" in {
    val board: Board = new FENParser().parseFENDescriptiontToBoard("rnbqkbnr/8/8/8/8/8/8/RNBQKBNR w KQkq - 0 1")
    ...
    val board: Board = new FENParser().parseFENDescriptiontToBoard("rnbqkbnr/8/8/8/8/8/8/RNBQKBNR b KQkq - 0 1")
    ...
    val board: Board = new FENParser().parseFENDescriptiontToBoard("8/8/rnbqkbnr/pppppppp/PPPPPPPP/RNBQKBNR/8/8 w - - 0 1")
...
//    BoardTestHelper.printList(board.getAllMoves())
 ...
 "An almost initial position " should " give such list of Moves" in {
    val board: Board = new FENParser().parseFENDescriptiontToBoard("rnbqkbnr/ppp1pppp/8/3pP3/8/8/PPPP1PPP/RNBQKBNR w KQkq 43 0 1")
 ...
 "White castling position " should " give castling allowed for both sides" in {
    val board: Board = new FENParser().parseFENDescriptiontToBoard("rnbqkbnr/pppppppp/8/8/8/8/P6P/R3K2R w KQkq - 0 1")
  ...
  "Black castling position " should " give castling allowed for both sides" in {
    val board: Board = new FENParser().parseFENDescriptiontToBoard("r3k2r/p6p/8/8/8/8/P6P/R3K2R b KQkq - 0 1")
 ...
 "White castling position but castling not allowed " should "  give no castling moves" in {
    val board: Board = new FENParser().parseFENDescriptiontToBoard("rnbqkbnr/pppppppp/8/8/8/8/P6P/R3K2R w kq - 0 1")
...
//    board.setBoardSpecialEvents()
    val newBoard: Board = BoardTestHelper.deepBoardCopy(board,
      ...
      old.isLongCastlingAllowedForBlack,0))
  ...
  "White castling position but king might be attacked from one side " should "  give one castling moves" in {
    val board: Board = new FENParser().parseFENDescriptiontToBoard("4kr2/8/8/8/8/8/P6P/R3K2R w KQkq - 0 1")
