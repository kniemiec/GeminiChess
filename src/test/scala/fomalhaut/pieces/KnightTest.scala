...
import fomalhaut.pieces.Knight
...
class KnightTest extends FlatSpec{
  ...
  "Knight from b1  " should " attack to fields " in {
    val knight = new Knight(List(1), new BoardSpecialEvents(0,true,true,true,true,0))
  ...
  "Knight from b1 with occupied a3, c1 and c2 and c3" should " attack fields " in {
    val queen = new Knight(List(1), new BoardSpecialEvents(0,true,true,true,true,0))
