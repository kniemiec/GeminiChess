...
import fomalhaut._
import fomalhaut.eva.BoardValueCalculator;
...
"position without black pawn" should " give value 100 " in {
     val initialPosition: Board = new FENParser().parseFENDescriptiontToBoard("rnbqkbnr/ppp1pppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq 43 0 1") 
     assert(BoardValueCalculator.calculateBoardValue(initialPosition) == 100)
  }

"position after e4" should " give value 10 " in {
     val initialPosition: Board = new FENParser().parseFENDescriptiontToBoard("rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR w KQkq 43 0 1") 
