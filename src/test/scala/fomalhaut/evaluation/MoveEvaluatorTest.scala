...
//  }
  ...
  "In this position " should "be checkmate in one after move Wh6xh5"  in {
    val initialPosition: Board = new FENParser().parseFENDescriptiontToBoard("8/8/7R/p4Npn/6p1/7k/r7/6K1 w - 43 0 1")
  ...
  "In this position " should "be checkmate in one after move Wf3xf4"  in {
    val initialPosition: Board = new FENParser().parseFENDescriptiontToBoard("8/8/3KNkp1/8/5r1p/5R2/8/8 w - 43 0 1")
  ...
  "In this position " should "be checkmate in one after move Se5:g6"  in {
    val initialPosition: Board = new FENParser().parseFENDescriptiontToBoard("8/8/7p/4NR2/6pk/r6b/7K/8 w - 43 0 1")
  ...
  "In this position " should "be checkmate in two after move f6f7"  in {
    val initialPosition: Board = new FENParser().parseFENDescriptiontToBoard("6k1/8/4pP1K/3pB2B/3P3P/8/6r1/8 w - 43 0 1")
  ...
  "In this position " should "be checkmate in two after move Gg3"  in {
    val initialPosition: Board = new FENParser().parseFENDescriptiontToBoard("1B6/1B6/8/8/6p1/7p/8/4K1k1 w - 43 0 1")
  ...
  "In this position " should "be checkmate in two after move Gc8:b7"  in {
    val initialPosition: Board = new FENParser().parseFENDescriptiontToBoard("k1B5/8/PK6/3b4/8/6B1/5p2/8 w - 43 0 1")
